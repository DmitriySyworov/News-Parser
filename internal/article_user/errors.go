...
var (
	...
	ErrParseUserURL                = errors.New("could not get a response from the resource you passed")
	ErrIncorrectURL                = errors.New("the url is incorrect")
	ErrIncorrectCategory           = errors.New("the category field must be at least 2 characters and no more than 30")
	ErrIncorrectDomain             = errors.New("the domain is required")
